...
1) Création du dockerfile. Il contiendra tout ce code:
...
# Utilise la variable d'environnement CUSTOM_MESSAGE. 
# Si elle n'est pas définie, utilise "Bienvenue à bord !" par défaut.
CMD ["Bienvenue à bord !"]
